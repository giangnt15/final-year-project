...
import { CREATE_COLLECTION, UPDATE_COLLECTION, GET_COLLECTION } from '../../api/collectionApi';
        ...
        <div className="content-wrapper">
            ...
            <div className="content-body">
                <Collapse defaultActiveKey={['1']}>
                    <Panel header={<span><i className="fa fa-info m-r-12"></i>Thông tin tuyển tập</span>} key="1" showArrow={false}>
                    ...
                    <Panel header={<span><i className="fa fa-book m-r-12"></i>Sách</span>} key="2" showArrow={false}>
                        <Fragment><div className="actions">
                            ...
                            <Button disabled={selectedRowKeys.length === 0}
                                ...
                                className="m-l-8" type="danger"><span><DeleteOutlined /> Xóa khỏi tuyển tập</span></Button>
                        </div>
                            <br />
